...
export default function InfoBadge({ className }: { className: string }) {
  return (
    <div className={`${className}`}>
      <div className="absolute w-[150px] h-[150px] bg-primary02 rounded-full z-0"></div>
      <div className="absolute right-0 bottom-0 w-[150px] h-[150px] bg-primary01 rounded-full z-0"></div>
      <div className="max-w-[343px] w-[100%] h-[163px] backdrop-blur-md border-2 rounded-[25px] m-auto mt-8 flex justify-center items-center z-20">
